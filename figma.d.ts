...
interface GroupNode extends BaseNodeMixin, SceneNodeMixin, ReactionMixin, ChildrenMixin, ContainerMixin, BlendMixin, LayoutMixin, ExportMixin, RelaunchableMixin {
  readonly type: "GROUP"
  clone(): GroupNode
}
